...
export const actionCodeSettings = {
  ...
  url: IS_DEV
    ? "http://localhost:3000/verify_signin"
    : "https://admin-barmanagerx.web.app/verify_signin",
    ...
    if (userVal) {
      try {
        await sendSignInLinkToEmail(auth, email, {
          ...
          url: IS_DEV
            ? `http://localhost:3000/verify_signin?email=${email}`
            : `https://admin-barmanagerx.web.app/verify_signin?email=${email}`,
          handleCodeInApp: true,
        });
