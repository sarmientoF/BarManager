...
const UpdateModal = ({ user, open, setOpen }: Props) => {
  ...
  const handleUpdate = async () => {
    ...
    updates["/attributes/name"] = convertHalfString(name);
    updates["/attributes/furigana"] = convertHalfString(furigana);
    updates["/attributes/birthday"] = _birthday;
    updates["/attributes/phone"] = converJpNumbers(phone);
    updates["/attributes/memo"] = memo;
    updates["/attributes/isInStore"] = user.attributes.isInStore;
    updates["/attributes/introducer"] = introducer;
    updates["/attributes/job"] = job;
    updates["/attributes/photo"] = newUrl;
